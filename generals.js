!function(e) {
    ...
    function o(e, t, n, i) {
      ...
      if (Array.isArray(e))
        ...
        if (g) {
          ...
          var E = ""
            , P = String(e);
          a("31", "[object Object]" === P ? "object with keys {" + Object.keys(e).join(", ") + "}" : P, E)
        }
      }
      return m
    }
  ...
  , function(e, t, n) {
    ...
    function c(e, t, n, r) {
      var o, c;
      if (b ? o = i(e) : w ? s(e, n) && (o = M.compositionEnd) : a(e, n) && (o = M.compositionStart),
          !o)
        return null;
      E && (w || o !== M.compositionStart ? o === M.compositionEnd && w && (c = w.getData()) : w = m.getPooled(r));
  ...
  , function(e, t, n) {
    ...
    function o(e) {
      var t = E.getPooled(_.change, k, e, P(e));
    ...
    var g = n(43)
      ...
      , I = null
      , N = !1;
    b.canUseDOM && (N = C("change") && (!document.documentMode || document.documentMode > 8));
    var O = !1;
    b.canUseDOM && (O = C("input") && (!document.documentMode || document.documentMode > 11));
    var D = {
      get: function() {
      ...
      extractEvents: function(e, t, n, o) {
        ...
        if (r(s) ? N ? i = u : a = c : M(s) ? O ? i = d : (i = m,
            a = f) : v(s) && (i = y),
            i) {
          var l = i(e, t);
          if (l) {
            var p = E.getPooled(_.change, l, n, o);
  ...
  , function(e, t, n) {
    "use strict";
    function r() {
      _.ReactReconcileTransaction && S ? void 0 : l("123")
    }
    function o() {
  ...
  , function(e, t, n) {
    ...
    function l() {
      ...
      switch (t ? void 0 : m("64"),
        ...
        case "iframe":
        case "object":
          e._wrapperState.listeners = [C.trapBubbledEvent("topLoad", "load", t)];
          break;
        case "video":
        case "audio":
          e._wrapperState.listeners = [];
          for (var n in K)
            K.hasOwnProperty(n) && e._wrapperState.listeners.push(C.trapBubbledEvent(n, K[n], t));
          break;
        case "source":
          e._wrapperState.listeners = [C.trapBubbledEvent("topError", "error", t)];
          break;
        case "img":
          e._wrapperState.listeners = [C.trapBubbledEvent("topError", "error", t), C.trapBubbledEvent("topLoad", "load", t)];
          break;
        case "form":
          e._wrapperState.listeners = [C.trapBubbledEvent("topReset", "reset", t), C.trapBubbledEvent("topSubmit", "submit", t)];
          break;
        case "input":
        case "select":
        case "textarea":
          e._wrapperState.listeners = [C.trapBubbledEvent("topInvalid", "invalid", t)]
      }
    }
    function p() {
  ...
  , function(e, t, n) {
    ...
    function a(e, t, n, r, o) {
      ...
      var u = P.mountComponent(e, n, null, T(e, t), o, 0);
      i && console.timeEnd(i),
        e._renderedComponent._topLevelWrapper = e,
        H._mountImageIntoNode(u, t, e, r, n)
    }
    function s(e, t, n, r) {
      var o = M.ReactReconcileTransaction.getPooled(!n && b.useCreateElement);
      o.perform(a, null, e, t, o, n, r),
        M.ReactReconcileTransaction.release(o)
    }
    function u(e, t, n) {
      for (P.unmountComponent(e, n),
  ...
  , function(e, t, n) {
    ...
    var r = n(3)
      ...
      componentDidMount: function() {
        c && c.username ? (this.state.username = c.username,
          this.setState({
            username: c.username
          })) : i.findDOMNode(this.refs.username).focus(),
          d.doWhenVisible(function() {
            y.isPrivateURL() ? this.props.joinPrivateGame.bind(this)(y.getPrivateID()) : y.isReplayURL() && u.getReplay(y.getReplayID(), m.startReplay)
          }
            .bind(this)),
      ...
      onPlayClicked: function() {
        return c.completed_tutorial ? void (c.completed_tutorial ? this.setState({
          showGameModes: !0
        }) : this.props.onPlayClassic.call(this)) : void m.startLocalTutorial(this.state.username)
      },
      ...
      onLeaderboardClicked: function() {
        this.setState({
          ...
          u.updateStarsAndRank(),
          u.getLeaderboard(this.onLeaderboardReceived)
      },
      ...
      onLeaderboardReceived: function(e, t) {
        this.setState({
          leaderboard: {
            users: e,
            stars: t
        ...
        c && (c.lb_users = JSON.stringify(e),
          c.lb_stars = JSON.stringify(t))
      },
      leaderboardRows: function() {
        var e, t;
        if (this.state.leaderboard)
          e = this.state.leaderboard.users,
            t = this.state.leaderboard.stars;
        else {
          if (!(c && c.lb_users && c.lb_stars))
            return null;
          try {
            e = JSON.parse(c.lb_users),
              t = JSON.parse(c.lb_stars)
          } catch (e) {
            return null
          }
        }
        ...
        return (t || []).map(function(t, o) {
          var i = n.props.rank === o + 1 && n.state.username === e[o];
          return r.createElement("tr", {
            key: "leaderboard-row-" + o,
            className: i ? "highlighted" : ""
          }, r.createElement("td", null, o + 1), r.createElement("td", null, e[o] || "Anonymous"), r.createElement("td", null, Math.max(0, Math.round(t || 0))))
        })
      },
      ...
      replayRows: function() {
        ...
        return e.map(function(e, t) {
          ...
          return r.createElement("tr", {
            ...
            href: "/replays/" + e.id
          }, new Date(e.started).toLocaleString())), r.createElement("td", null, e.turns), r.createElement("td", null, n.join(" ")))
        })
      },
      ...
      render: function() {
        return r.createElement("div", {
        ...
        }, "generals.io"), r.createElement("h2", {
          style: {
            margin: 0
          }
        }, r.createElement(p, {
        ...
        }, "Rank #", this.props.rank) : null, r.createElement("input", {
          style: {
            border: "none"
          },
          ref: "username",
          ...
          className: "inverted",
          onClick: this.props.onPlayClassic.bind(this)
        }, "Classic"), r.createElement("p", {
          style: {
            marginBottom: "10px"
          }
        ...
        }, r.createElement("tbody", null, r.createElement("tr", null, r.createElement("th", null, "#"), r.createElement("th", null, "Username"), r.createElement("th", null, " ", r.createElement(p, null), " ")), this.leaderboardRows()))), r.createElement("button", {
        ...
        }, "Replays"), r.createElement(a, {
          id: "replays-table-container",
          loadMore: this.loadMoreReplays,
          hasMore: !v.getState().menu.replaysFinished,
          loader: r.createElement("div", {
            className: "loader"
          }, "Loading..."),
          useWindow: !1,
          threshold: 500
          ...
          id: "replays-table"
        }, r.createElement("thead", null, r.createElement("tr", null, r.createElement("th", null, "Time"), r.createElement("th", null, "Turns"), r.createElement("th", null, "Result"))), r.createElement("tbody", null, this.replayRows()))), r.createElement("button", {
          className: "small inverted center-horizontal",
    ...
    e.exports = o.connect(function(e) {
      ...
      return {
        onPlayClassic: function() {
          u.play(this.state.username),
            this.closeGameModes(),
            e(s.play())
        },
        onPlay1v1: function() {
          u.playPrivate("1v1", this.state.username),
            this.closeGameModes(),
            e(s.play("1v1"))
        },
        joinPrivateGame: function(t) {
          u.playPrivate(t, this.state.username),
            e(s.play(t))
        }
      }
    })(b)
              ...
              if (this.unsubscribe) {
                ...
                if (!T || t !== e) {
                  if (T && !this.doStatePropsDependOnOwnProps) {
                    ...
                    if (!n)
                      return;
                    n === _ && (this.statePropsPrecalculationError = _.value),
        ...
        u(t, [{
          ...
          value: function() {
            var e = this
              ...
              t.useWindow,
              t.isReverse,
              o(t, ["children", "element", "hasMore", "initialLoad", "loader", "loadMore", "pageStart", "threshold", "useWindow", "isReverse"]));
            return s.ref = function(t) {
              e.scrollComponent = t
            }
              ,
              l.default.createElement(r, s, n, i && (a || this._defaultLoader))
          }
        }, {
          ...
          value: function() {
            ...
            if (this.props.useWindow) {
              var r = void 0 !== t.pageYOffset ? t.pageYOffset : (document.documentElement || document.body.parentNode || document.body).scrollTop;
              n = this.props.isReverse ? r : this.calculateTopPosition(e) + e.offsetHeight - r - window.innerHeight
            } else
              n = this.props.isReverse ? e.parentNode.scrollTop : e.scrollHeight - e.parentNode.scrollTop - e.parentNode.clientHeight;
            n < Number(this.props.threshold) && (this.detachScrollListener(),
          ...
          value: function() {
            if (this.props.hasMore) {
              var e = window;
              0 == this.props.useWindow && (e = this.scrollComponent.parentNode),
                e.addEventListener("scroll", this.scrollListener),
                e.addEventListener("resize", this.scrollListener),
          ...
          value: function() {
            ...
            0 == this.props.useWindow && (e = this.scrollComponent.parentNode),
              ...
              e.removeEventListener("resize", this.scrollListener)
          }
        }, {
          ...
          value: function(e) {
            this._defaultLoader = e
          }
        }]),
        t
    }(c.Component);
    p.propTypes = {
      element: c.PropTypes.string,
      hasMore: c.PropTypes.bool,
      initialLoad: c.PropTypes.bool,
      loadMore: c.PropTypes.func.isRequired,
      pageStart: c.PropTypes.number,
      threshold: c.PropTypes.number,
      useWindow: c.PropTypes.bool,
      isReverse: c.PropTypes.bool
    },
      p.defaultProps = {
        element: "div",
        hasMore: !1,
  ...
  , function(e, t, n) {
    "use strict";
    function r() {
      k.emit("stars_and_rank", m)
    }
    function o(e) {
      k.emit("play", e, m),
        k.emit("set_username", m, e)
    }
    function i(e, t) {
      k.emit("join_private", e, t, m),
        k.emit("set_username", m, t)
    }
    function a(e, t, n, r) {
      y.getState().game.isLocalGame ? C.handleAttack(e, t, n, r) : k.emit("attack", e, t, n, r)
    }
    function s() {
      k.emit("cancel", y.getState().queue.queue_id)
    }
    function u(e) {
      k.emit("set_force_start", y.getState().queue.queue_id, e)
    }
    function c(e, t) {
      k.emit("chat_message", e, t)
    }
    function l(e) {
    ...
    function h() {
      y.getState().game.isLocalGame ? C.clearMoves() : k.emit("clear_moves")
    }
    function d(e, t) {
    ...
    var m, v = n(212), y = n(265), g = n(210), T = n(269), b = n(268), S = n(277), A = n(278), E = n(287), P = n(176), C = n(288);
    if (E && E.user_id ? m = E.user_id : (m = A(),
      E && (E.user_id = m)),
        console.log("user_id: " + m),
        E) {
      if (E.hasOwnProperty("stars")) {
        var M = parseFloat(E.stars);
        console.log("cached stars: " + M),
          y.dispatch(g.stars(M))
      }
      if (E.hasOwnProperty("rank")) {
        var _ = parseInt(E.rank);
        console.log("cached rank: " + _),
          y.dispatch(g.rank(_))
      }
    }
    var w = "http://ws.generals.io";
    "localhost" === window.location.hostname && (w = "http://localhost:8080"),
    window.location.hostname.indexOf("ngrok") >= 0 && (w = window.location.toString()),
    "eu." === window.location.hostname.substring(0, 3) && (w = "http://euws.generals.io");
    var k = v(w, {
      transports: ["websocket"]
    })
      , x = !1;
    k.on("connect", function() {
      x ? console.log("Reconnected to server.") : console.log("Connected to server."),
        x = !0,
        r()
    }),
      k.on("disconnect", function() {
        console.log("Disconnected from server."),
        y.getState().page !== P.PAGE_GAME || y.getState().game.isLocalGame || alert("Disconnected from server. Please refresh the page.")
      }),
      k.on("pre_game_start", function() {
        y.dispatch(T.prestart())
      }),
      k.on("game_start", function(e) {
        y.dispatch(T.start(e))
      }),
      k.on("game_update", function(e) {
        y.dispatch(T.update(e))
      }),
      k.on("queue_update", function(e, t, n) {
        y.dispatch(b.update(e, t, n))
      }),
      k.on("chat_message", function(e, t) {
        y.dispatch(S.receiveMessage(e, t))
      }),
      ...
      k.on("replay_list", function(e) {
        y.dispatch(g.receiveReplayList(e))
      }),
              ...
              if (!n("json")) {
                ...
                if (!T)
                  var _ = h.floor
                    ...
                    , k = function(e, t) {
                    return w[t] + 365 * (e - 1970) + _((e - 1969 + (t = +(t > 1))) / 4) - _((e - 1901 + t) / 100) + _((e - 1601 + t) / 400)
                  };
                if ((f = y.hasOwnProperty) || (f = function(e) {
                  ...
                  var x = {
                    ...
                    , O = "\\u00"
                    , D = function(e) {
                    for (var t = '"', n = 0, r = e.length, o = !M || r > 10, i = o && (M ? e.split("") : e); n < r; n++) {
                    ...
                    var s, u, c, l, h, d, y, T, b, M, w, x, I, O, B, G;
                    try {
                      s = t[e]
                    } catch (e) {}
                    if ("object" == typeof s && s)
                      if (u = g.call(s),
                        u != S || f.call(s, "toJSON"))
                        "function" == typeof s.toJSON && (u != A && u != E && u != P || f.call(s, "toJSON")) && (s = s.toJSON(e));
                      else if (s > -1 / 0 && s < 1 / 0) {
                        if (k) {
                          for (h = _(s / 864e5),
                                 c = _(h / 365.2425) + 1970 - 1; k(c + 1, 0) <= h; c++)
                            ;
                          for (l = _((h - k(c, 0)) / 30.42); k(c, l + 1) <= h; l++)
                            ;
                          h = 1 + h - k(c, l),
                        ...
                        s = (c <= 0 || c >= 1e4 ? (c < 0 ? "-" : "+") + N(6, c < 0 ? -c : c) : N(4, c)) + "-" + N(2, l + 1) + "-" + N(2, h) + "T" + N(2, y) + ":" + N(2, T) + ":" + N(2, b) + "." + N(3, M) + "Z"
                      } else
                        s = null;
                    if (n && (s = n.call(t, e, s)),
                      null === s)
  ...
  , [318, 251], [319, 252], 217, function(e, t, n) {
    (function(t) {
        function r() {}
        function o(e) {
          i.call(this, e),
  ...
  , function(e, t, n) {
    ...
    function r(e, t) {
      switch (e = e || {},
        ...
        case o.ACTION_REPLAYLIST:
          var n = e.replays || [];
          return Object.assign({}, e, {
            replays: n.concat(t.data),
    ...
    function r(e, t) {
      switch (e = e || {
        ...
        case o.ACTION_UPDATE:
          var n;
          var x;
          t.map instanceof i ? n = t.map : (n = new i,
    ...
    n.prototype.size = function() {
      ...
      n.prototype.visibleFrom = function(e, t) {
        ...
        for (var n = Math.floor(e / this.width), r = Math.floor(e % this.width), o = -1; o <= 1; o++)
          for (var i = -1; i <= 1; i++)
            if (!(0 === o && 0 === i || n + o < 0 || n + o >= this.height || r + i < 0 || r + i >= this.width || this.tileAt(this.indexFrom(n + o, r + i)) !== t))
              return !0;
        return !1
      }
      ,
      ...
      n.prototype.serialized = function(e, t) {
        for (var r = [], o = [], i = 0; i < this._map.length; i++)
          this.visibleFrom(i, e) ? (o.push(this._map[i]),
            r.push(this._armies[i])) : (o.push(this.tileAt(i) === n.TILE_MOUNTAIN || t.indexOf(i) >= 0 ? n.TILE_FOG_OBSTACLE : n.TILE_FOG),
            r.push(0));
      ...
      ,
      n.prototype.attack = function(e, t, r) {
        if (!this.isAdjacent(e, t))
          return void console.error("Attack for non-adjacent tiles " + e + ", " + t);
        if (this.tileAt(t) !== n.TILE_MOUNTAIN && !(this._armies[e] <= 1)) {
          var o = r ? Math.ceil(this._armies[e] / 2) : 1;
          this.tileAt(t) === this.tileAt(e) ? this._armies[t] = this._armies[e] + this._armies[t] - o : this._armies[t] >= this._armies[e] - o ? this._armies[t] = this._armies[t] - this._armies[e] + o : (this._armies[t] = this._armies[e] - o - this._armies[t],
  ...
  , function(e, t, n) {
    ...
    function o(e) {
      var t = {
        emit: v,
        gio_username: e,
        gio_stars: Math.max(0, Math.round(M.getState().menu.stars || 0))
      }
        , n = {
        emit: r,
      ...
      M.dispatch(_.prestart()),
        T = new P([t, n],!1,P.types.TUTORIAL),
        T.start(function() {
          T = null,
    ...
    function i(e) {
      ...
      if (!t)
        return void M.dispatch(_.invalidReplay());
      var n = 0
        , r = {};
    ...
    function a(e, t) {
      var n = P.createFromReplay(e);
      M.dispatch(_.prestart(!0)),
        M.dispatch(_.start({
          playerIndex: null,
          replay_id: e.id,
    ...
    function u() {
      M.getState().game.autoPlay && l(),
      k && setTimeout(u, 500 / M.getState().game.autoPlaySpeed)
    }
    function c() {
      k = !1
    }
    function l(e) {
      ...
      if (!(T.alivePlayers <= 1)) {
        ...
        for (; b.afks.length > E && b.afks[E].turn <= T.turn; ) {
          var r = b.afks[E++]
            , o = r.index;
          T.deaths.indexOf(T.sockets[o]) >= 0 ? T.tryNeutralizePlayer(o, S[o]) : (T.deaths.push(T.sockets[o]),
            T.alivePlayers--)
        }
        T.update(!0),
        e || p()
    ...
    function v(e, t) {
      switch (e) {
        case "game_start":
          M.dispatch(_.start(t, !0, !0));
          break;
        case "game_update":
          M.dispatch(_.update(t));
          break;
        case "game_won":
          M.dispatch(_.win(t));
          break;
    ...
    var T, b, S, A, E, P = n(289), C = n(290), M = n(265), _ = n(269), w = n(287), k = (n(271),
    ...
    function r(e, t, n, o, i) {
      if (e) {
        ...
        for (var s = 0; s < e.length; s++)
          ...
          u || e[s].join(this.chat_room),
            this.attackIndices.push(0);
        if (!o) {
          for (var c = !1; !c || !this.validateGame(); )
            c = this.tryInitializeGame(e);
    ...
    r.prototype.addMountain = function(e) {
      ...
      r.createFromReplay = function(e) {
        var t = e.generals.map(function(t, n) {
          ...
          , o = new r(t,!1,r.types.REPLAY,!0,n);
        o.cities = [],
          o.generals = [],
          o.map = new i(e.mapWidth,e.mapHeight);
      ...
      r.prototype.tryInitializeGame = function(e) {
        ...
        e.length <= 2 && (n = Math.round(1.5 * t + 3 * Math.random()),
          ...
          a *= 2,
          u = Math.round(e.length * (4 + Math.random()))),
          this.map = new i(n,o);
        var c = this.map.size();
        this.generals = [];
        for (var l = 0; l < e.length; l++) {
          for (var p, d = !1, f = 0; !d; ) {
            if (f++,
              f > 5e3)
              return !1;
            p = Math.floor(Math.random() * c),
              d = !0;
            for (var m = 0; m < this.generals.length; m++)
              if (this.map.distance(this.generals[m], p) <= a) {
                d = !1;
                break
              }
          }
        ...
        for (var T = c * (.2 + .08 * Math.random()), l = 0; l < T; l++) {
          var v = Math.floor(Math.random() * c);
          this.hasCityOrGeneral(v) ? l-- : this.addMountain(v)
        }
        return !0
      }
      ,
      ...
      r.prototype.validateGame = function() {
        ...
        for (var e = 0; e < this.generals.length; e++)
          for (var t = 0; t < e; t++)
            if (this.map.distance(this.generals[e], this.generals[t]) <= h)
              return console.error("Generals too close!", this.generals, this.map.width),
                !1;
        ...
        for (var n = this.generals.map(function() {
          ...
          for (var t = 0; t < this.generals.length; t++)
            this.map.distance(this.cities[e], this.generals[t]) <= d && n[t]++;
        if (n = n.sort(o),
          n[0] < 1)
          return !1;
      ...
      r.prototype.update = function(e) {
        ...
        if (!e) {
          ...
          if (!this.starsCompleted || this.starsCompleted < this.sockets.length) {
            ...
            this.starsCompleted === this.sockets.length && (this.replay.stars = this.sockets.map(function(e) {
              return e.gio_stars
            })),
              o.stars = this.stars
          }
          var i = this;
          if (this.sockets.forEach(function(e, t) {
              if (!(i.leftSockets.indexOf(e) >= 0)) {
                o.attackIndex = i.attackIndices[t],
                  o.map = i.map.serialized(t, i.cities);
                var n = function(e) {
                  return i.map.visibleFrom(e, t)
                }
                  , r = function(e) {
                  return i.map.visibleFrom(e, t) ? e : -1
                };
                o.cities = i.cities.filter(n),
                  o.generals = i.generals.filter(r),
                  e.emit("game_update", o)
              }
            }),
            this.alivePlayers <= 1) {
            for (var t = 0; t < this.generals.length; t++)
              if (this.deaths.indexOf(this.sockets[t]) < 0) {
                var a = this.sockets[this.map.tileAt(this.generals[t])];
                this.deaths.push(a),
                  a.emit("game_won"),
                u || io.to(this.chat_room).emit("chat_message", this.chat_room, {
                  text: this.sockets[t].gio_username + " wins!"
                });
                break
              }
            return !0
      ...
      r.prototype.bufferAttack = function(e, t, n, r, o) {
        ...
        return i < 0 ? void console.error("Client Input for socket_id not in game: " + e) : void (this.map.tileAt(t) === i && this.inputBuffer[i].push([t, n, r, o]))
      }
      ,
      ...
      r.prototype.handleQuit = function(e) {
        ...
        if (u || io.to(this.chat_room).emit("chat_message", this.chat_room, {
          ...
          var n = this.generals[t];
          this.alivePlayers--;
          var r = this;
          this.replay.addAFK(t, this.turn),
            setTimeout(function() {
              r.tryNeutralizePlayer(t, n)
            }, this.options.TIMEOUT_CAPTURE_AFK || f)
        }
      }
      ,
        ...
        r.prototype.addMove = function(e, t, n, r, o) {
          ...
          r.prototype.serialize = function() {
            var e = this.moves.map(o)
              , n = this.afks.map(a);
            return new t(c.compressToUint8Array(JSON.stringify([this.version, this.id, this.mapWidth, this.mapHeight, this.usernames, this.stars, this.cities, this.cityArmies, this.generals, this.mountains, e, n])))
          }
          ,
  ...
  , function(e, t, n) {
    ...
    var r = n(3)
      ...
      isPrivateGame: function() {
        return this.props.queue_id && "1v1" !== this.props.queue_id
      },
      componentDidMount: function() {
        this.isPrivateGame() && u.changeURL("/games/" + encodeURIComponent(this.props.queue_id)),
          googletag.cmd.push(function() {
      ...
      render: function() {
        ...
        }, "http://" + window.location.hostname + "/games/" + encodeURIComponent(this.props.queue_id))) : r.createElement("h1", {
          className: "queue-title"
        }, "Waiting for players..."), r.createElement("h2", null, this.props.numPlayers, " of ", n ? 2 : s.PLAYER_CAP), !this.props.prestart && !this.props.queue_id && this.props.numPlayers >= 2 ? r.createElement("p", null, "Game automatically starting in ", e, ":", t) : null, this.props.prestart ? null : r.createElement("p", {
          style: {
            fontSize: "14px",
            margin: "10px"
          }
        }, "We'll play a gong sound when the game starts. Turn your volume up!"), !this.props.prestart && !n && this.props.numPlayers > 1 ? r.createElement("button", {
          onClick: this.onForceClicked,
          className: this.state.isForceStarting ? "inverted" : ""
        }, "Force Start ", this.props.numForce, " / ", Math.ceil(.7 * this.props.numPlayers)) : null, r.createElement("br", null), this.props.prestart ? null : r.createElement("button", {
          className: "small",
  ...
  , function(e, t, n) {
    ...
    var i = n(3)
      ...
      exit: function() {
        this.props.isReplay && v.exitReplay(),
          l.dispatch(s.exit()),
          f.leaveGame()
      },
      clearMoves: function() {
      ...
      render: function() {
        ...
        return i.createElement("div", {
        ...
        }) : null, this.props.won ? this.props.isTutorial ? i.createElement(h, {
          title: "You won!",
          button: "Exit",
          onClick: this.exit
        }) : i.createElement(h, {
          ...
          id: "turn-counter"
        }, "Turn ", t), this.props.isReplay ? null : i.createElement("button", {
          className: "small",
        ...
        }, this.state.useShareReplayStartTurn ? "http://" + window.location.hostname + "/replays/" + this.props.replay_id + "?t=" + (this.state.shareReplayStartTurn || Math.floor(this.props.turn / 2)) : "http://" + window.location.hostname + "/replays/" + this.props.replay_id), i.createElement("input", {
          type: "checkbox",
          style: {
            display: "inline-block"
          },
        ...
        }, "10x"))) : null, !this.props.isReplay || y ? null : i.createElement("div", {
          ...
          className: "bold"
        }, "[→]"), i.createElement("br", null), "Next Move"))), this.props.isTutorial ? i.createElement(d, {
    ...
    var i = n(3)
      ...
      onKeyDown: function(e) {
        ...
        if (!(this.state.selectedIndex < 0)) {
          ...
          s === this.props.playerIndex && this.onTileClick(i, a),
